...
object Constants {
    ...
    const val API_RESET_SEND_VERIFY_EMAIL = "/v3/account/email/{account}"
    const val API_RESET_VERIFY_EMAIL = "/v3/account/reset/verify"
    const val API_RESET_PASSWORD = "/v3/account/reset/password"
